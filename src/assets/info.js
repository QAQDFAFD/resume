    ...
    projects: [
        {
            ...
            time: '2023年6月 - 至今',
            company: '百胜中国',
            intro: '：该项目是一个公司内部使用的运维工具平台，具有库表数据的监控、数据源的配置、数据表及字段级别的标注、SQL在线执行、数据集的配置、告警配置等功能，可以帮助大数据工程师完成一系列的数据方面的便捷操作。配合相关已有平台作为公司 AI 团队的重要环节，执行数据治理，异常定位等功能。团队成员由1个技术leader+3个大数据+1个后端+1个前端组成。',
        ...
        },
        {
            ...
            intro: '该项目是一个移动端微信小程序的游戏化测评（后期重构 H5 版本），小程序基于专业的认知神经心理学原理、以游戏化测评为主要表现形式的能力测评工具，致力于为青年人才提供专业的人才测评服务。团队成员由2个产品+1个UI+4个前端+1个后端组成。',
